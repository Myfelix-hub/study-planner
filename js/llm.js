...
要求：
1. 任务要具体可执行（写明科目+内容+范围，例如"数学：预习八上第一章《三角形》第1节并做课后练习"）；
2. 【最重要】只围绕「本周目标」中用户明确提到的科目生成任务，用户没提到的科目一律不要安排。例如目标只写"下周每天学习50个英语单词"，就只给英语排每天背单词的任务，其他科目一个任务都不要生成；
3. 只有当「本周目标」为空、或没有点名任何科目时，才按全科目均衡原则安排：每天 3-5 个任务；数学、英语、物理是三大重点科目，每天都要安排其中至少两科，三科合计时长占当天学习时长的 60% 以上；文理搭配，同一科目不要连续多天高强度；每天安排 10-30 分钟体育或阅读；
